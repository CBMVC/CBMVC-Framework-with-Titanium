...
@interface CoderBlogObject : KrollCoverageObject {
#else
@interface CoderBlogObject : KrollObject {
#endif
@private
...
extern NSString * CoderBlog$ModuleRequireFormat;
