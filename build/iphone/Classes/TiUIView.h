...
/**
 Base class for all CoderBlog views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CoderBlog view hierarchy (such as wrapped iOS UIViews) was touched.
