...
// in simulator we redefine to format for CoderBlog Developer console
...
{\
	NSString * exceptionName = [@"org.coderblog." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.coderblog";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UICoderBlogNativeItemNone = -1, 
	UICoderBlogNativeItemSpinner = -2,
	UICoderBlogNativeItemProgressBar = -3,
	
	UICoderBlogNativeItemSlider = -4,
	UICoderBlogNativeItemSwitch = -5,
	UICoderBlogNativeItemMultiButton = -6,
	UICoderBlogNativeItemSegmented = -7,
	
	UICoderBlogNativeItemTextView = -8,
	UICoderBlogNativeItemTextField = -9,
	UICoderBlogNativeItemSearchBar = -10,
	
	UICoderBlogNativeItemPicker = -11,
	UICoderBlogNativeItemDatePicker = -12,
	
	UICoderBlogNativeItemInfoLight = -13,
	UICoderBlogNativeItemInfoDark = -14,
	
	UICoderBlogNativeItemDisclosure = -15,
	
	UICoderBlogNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CoderBlog instances of
