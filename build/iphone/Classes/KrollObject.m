 ...
 * Copyright (c) 2009-2011 by CoderBlog, Inc. All Rights Reserved.
...
//@interface CoderBlogObject : NSObject
//@end

@interface CoderBlogObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CoderBlogObject class]])
		{
			for (NSString *key in [[(CoderBlogObject*)o modules] allKeys])
			{
