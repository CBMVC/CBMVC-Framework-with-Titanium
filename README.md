...
The framework can support multiple language, and can be effective immediately after changed the language:
 ...
 1. Create a language xml file under /Resources/app/languages/ folder, and please follow the following file name format :
...
/Resources/app/languages/zf.xml
...
3. Also you can set the default language with first launch the app:
/Resources/app.js
